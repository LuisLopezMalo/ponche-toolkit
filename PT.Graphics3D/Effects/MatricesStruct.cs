...
namespace PT.Graphics3D.Effects
{
    ...
    public struct MatricesStruct
    {
        ...
        /// <param name="worldView">The cpu pre-multiplied world-view matrix.</param>
        ...
        /// <param name="worldInverseTranspose">The cpu pre-multiplied world inversed transposed matrix.</param>
