...
namespace PoncheToolkit.Graphics3D
{
    ...
    public sealed class PTMesh : GameRenderableComponent, System.ICloneable
    {
        ...
        public void Apply(PTEffect effect, DeviceContext1 context)
        {
            UpdateMatrices(Game.CurrentCamera);

            //// if reflectionEnabled, update the new position of the reflectionCamera.
            //Game.CurrentCamera.UpdateMatrices(model.Position);
        ...
        public void SetMaterial(PTMaterial material)
        {
            if (string.IsNullOrEmpty(material.Name))
                throw new System.ArgumentNullException("The material to be applied has no name.");
