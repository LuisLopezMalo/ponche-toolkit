...
namespace Core.Management.Text
{
    ...
    /// </summary>
    public class CustomFontFileStream : CallbackBase, FontFileStream
    {
        private readonly DataStream stream;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomFontFileStream"/> class.
        /// </summary>
        /// <param name="stream">The stream.</param>
        public CustomFontFileStream(DataStream stream)
        {
            this.stream = stream;
        }
